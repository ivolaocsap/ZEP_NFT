...
//0010110- ASHTAR COMMAND- NESARA GESARA ACTIVATE
// Base contract credit: OpenZeppelin
//Minor improvments: Analog Mandala
import "./ERC721/presets/ERC721PresetMinterPauserAutoId.sol";
import "./BidExecutor.sol";
//WE ARE ONE WE ARE LOVE WE ARE THE ZEP FAMILLY 
//ALLWAYS FLYING HIGH WE SHALL FREE THE HUMAN RACE 
//AND SO BE IT ZEPPELIN DAO PROJECT WILL DO THE IMPOSSIBLE

contract ZEPPELINFT is ERC721PresetMinterPauserAutoId {
